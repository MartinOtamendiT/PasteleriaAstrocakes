        ...
        <div class="row g-0 justify-content-center">
            <div class="login-window">
                <?php
                    ...
                    elseif($error == 2){
                        print('<div class="alert alert-warning">Múltiples usuarios. Contacte al administrador</div>');
                    }
                    elseif($error == 3){
                        print('<div class="alert alert-danger">Usuario no registrado</div>');
                    }
                    elseif($error == 4){
                        print('<div class="alert alert-info">Usuario registrado con éxito</div>');
                    }
                ?>
                <form action="validar.php" method="post">
                    <div><h2>Log In</h2></div>
                    <img class="astronaut-login" src="../img/astronaut-login.gif" alt="Profile Picture">
                    <div>
                    ...
                    <br>
                    <div>
                        <label class="form-label">¿No tienes una cuenta aún?</label>
                        <a href="sign_in.php">Crear cuenta</a><br>
